$(document).ready(function() {
  ...
  $(".navbar a, .btn, footer a[href='#myPage']").on('click', function(event) {
...
/* Executing loader script and transitioning to page */
...
/* Loader Page JavaScript - By George Hoqqanen */
...
document.addEventListener("DOMContentLoaded", function(event) {
  var phrases = shuffleArray(["FunGames","Perbaikan Login Google", "Penghapusan Login Email", "Maintenance"]);
